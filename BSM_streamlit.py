...
r = st.sidebar.number_input("Risk-Free Rate", min_value=0.000, max_value=1.000, step=0.0001, value=0.0339)
...
sigma = st.sidebar.number_input("Volatility", min_value=0.000, max_value=1.000, step=0.0001, value=0.85664, format="%1.6f")
